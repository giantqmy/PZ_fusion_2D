...
if __name__ == '__main__':
    ...
    model = YOLO(r'/media/ddc/新加卷/hys/qmy/PZ_8/ultralytics/cfg/models/11/yolo11s.yaml')

    model.train(data=r"/media/ddc/新加卷/hys/qmy/PZ_8/ultralytics/cfg/datasets/pz6.yaml",
                    ch = 9, # yz32.yaml文件路径
